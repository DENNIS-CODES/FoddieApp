...
//static class uses app settings and resources to verify chefs mobile no
    ...
    EditText entercode;
    String phoneno;
//using an API to verify phone no through sending a short code message to the number provided by user
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chefsendotp);

        phoneno = getIntent().getStringExtra("Phonenumber").trim();//gets phone no
//viewing the affected XML files
